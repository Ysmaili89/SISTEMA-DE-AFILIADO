...
class ProductForm(FlaskForm):
    ...
    categoria_id = SelectField('CategorÃ­a', coerce=lambda x: int(x) if x else None, validators=[DataRequired(message='Por favor, selecciona una categorÃ­a.')])
...
class PublicTestimonialForm(FlaskForm):
    ...
    fax_number = StringField('NÃºmero de Fax (no rellenar)', validators=[Optional()])  # Honeypot anti-spam
...
# -----------------------------------------------------------------------------
# Nuevo: Formulario de configuraciÃ³n de Adsense
# -----------------------------------------------------------------------------
